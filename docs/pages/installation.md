...
```sh
curl -fsSL https://raw.githubusercontent.com/XenonIsAwesome/docker-image-merge/refs/heads/main/scripts/install.sh | sudo sh -s -- --system
```
...
```sh
curl -fsSL https://raw.githubusercontent.com/XenonIsAwesome/docker-image-merge/refs/heads/main/scripts/install.sh | sh -s -- --dir /opt/docker-plugins
```
...
```powershell
iwr -useb https://raw.githubusercontent.com/XenonIsAwesome/docker-image-merge/refs/heads/main/scripts/install.ps1 -OutFile install.ps1
.\install.ps1 -System
```
